...
import com.yvillegas.movieapp.databinding.TopRatedBinding
...
class TopRatedConcatAdapter(private val movieAdapter: MovieAdapter): RecyclerView.Adapter<BaseConcatHolder<*>>(){
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseConcatHolder<*> {
        val itemBinding = TopRatedBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    private inner class ConcatViewHolder(val binding: TopRatedBinding): BaseConcatHolder<MovieAdapter>(binding.root){
